...
handleForceMute = function (config, sessionId, streamId, excludedSteamIds = null, callback) {
...
exports.forceMuteAll = function(config, sessionId, excludedSteamIds, callback) {
    return this.handleForceMute(config,sessionId,null,excludedSteamIds,callback);
}
